...
FerrumGate v1 deployment, configuration, and runtime surface overview.
For operator procedures (deployment, backup, restore, recovery, incidents), see:
...
ferrumctl server inspect-approvals   # List approvals (pagination and filtering via HTTP at /v1/approvals)
