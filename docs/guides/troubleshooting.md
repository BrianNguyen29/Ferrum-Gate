...
2. Verify the endpoint-to-scope mapping in [`docs/production-readiness-v2/12-endpoint-to-scope-mapping.md`](../../production-readiness-v2/12-endpoint-to-scope-mapping.md).
...
- For replica lag, see [`docs/production-readiness-v2/read-replica-design.md`](../../production-readiness-v2/read-replica-design.md) (design only; no implementation).
