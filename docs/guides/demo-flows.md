...
> **Parent**: [`docs/ROADMAP.md`](../../ROADMAP.md) §3.9
...
> **Validated evidence**: `docker-compose.demo.yml` and `docker-compose.postgres-demo.yml` were locally validated on 2026-05-19. See [`docs/implementation-path/artifacts/2026-05-19-compose-demo-evidence.md`](../../implementation-path/artifacts/2026-05-19-compose-demo-evidence.md) and [`docs/implementation-path/artifacts/2026-05-19-compose-demo-pg-evidence.md`](../../implementation-path/artifacts/2026-05-19-compose-demo-pg-evidence.md).
...
- [`docs/ROADMAP.md`](../../ROADMAP.md) — §3.9 source for demo flow definitions
