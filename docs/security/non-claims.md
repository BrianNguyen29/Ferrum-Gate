...
| Document | Purpose |
|----------|---------|
| [`../guides/security-model.md`](../guides/security-model.md) | Scoped token and RBAC implementation |
| [`../guides/operator.md`](../guides/operator.md) | Operator procedures and token rotation |
| [`PRODUCTION_NOTES.md`](../PRODUCTION_NOTES.md) | Production notes and readiness boundaries |
