...
Supported CLI lifecycle commands are evidenced in [`../implementation-path/artifacts/2026-05-28-phase1.4-ferrumctl-token-lifecycle-evidence.md`](../implementation-path/artifacts/2026-05-28-phase1.4-ferrumctl-token-lifecycle-evidence.md).
...
- [`2026-05-28-phase1.1-scoped-token-model-evidence.md`](../implementation-path/artifacts/2026-05-28-phase1.1-scoped-token-model-evidence.md)
- [`2026-05-28-phase1.2-deny-by-default-evidence.md`](../implementation-path/artifacts/2026-05-28-phase1.2-deny-by-default-evidence.md)
- [`2026-05-28-phase1.3-token-lifecycle-evidence.md`](../implementation-path/artifacts/2026-05-28-phase1.3-token-lifecycle-evidence.md)
- [`2026-05-28-phase1.4-ferrumctl-token-lifecycle-evidence.md`](../implementation-path/artifacts/2026-05-28-phase1.4-ferrumctl-token-lifecycle-evidence.md)
