...
| [008](008-r3-approval-timeout-mfa.md) | R3 Approval Timeout and Second Factor | Accepted (TOTP, lockout, and approval timeout implemented; WebAuthn and backup codes deferred) |
...
| [012](012-policy-bundle-rule-semantics.md) | PolicyBundle PDP Rule Semantics | Accepted (Phase 1 implemented) |
...
| [019](019-ambiguous-side-effect-recovery.md) | Explicit Ambiguous-Side-Effect Recovery State | Accepted |
