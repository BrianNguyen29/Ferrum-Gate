...
| H1 shipped summary | `implementation-path/01-current-state.md` | H1 sub-slices shipped post-v2 ratification (H1.1a, H1.2b, H1.3a, H1.4b, H1.4c, H1.5a); remaining H1 slices ⬜ PLANNED |
