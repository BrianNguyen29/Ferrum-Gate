...
| 12 | Approval listing/query in supported scope | `00-project-canon.md:44` | `crates/ferrum-gateway/src/server.rs:734-809,981-990,1008-1017`, `crates/ferrum-store/src/sqlite/approvals.rs:93-127` | `integration_gateway_flow.rs:1388-1561,1569-1807` | `16-release-checklist.md:24-25`, `25-EV-v1-single-node-rc-evidence.md:36-38,157-159`, `23-production-readiness-assessment.md:59` | VERIFIED | |
