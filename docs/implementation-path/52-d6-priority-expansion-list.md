...
- PostgreSQL full-production posture (priority 1) remains **not implemented** per ADR-50; local Docker/runtime/store support is implemented through the bounded P3/P4.1-P4.3 path. P4.4 MVP complete (dry-run default, --apply, empty-target safety, count+ID validation); P5 production readiness deferred.
