...
100: 90d. [artifacts/2026-05-09-gcp-phase3j-duckdns-tls-attempt.md](artifacts/2026-05-09-gcp-phase3j-duckdns-tls-attempt.md) — **GCP ONLY / NON-PROD**: Phase 3J DuckDNS TLS attempt; DNS A resolves correctly to VM IP (34.158.51.8), but ACME certificate issuance BLOCKED by DuckDNS/CAA DNS instability (CAA lookup timeout, SERVFAIL); rolled back to nip.io; NOT production-ready, NOT DuckDNS TLS success, NOT real owned domain
