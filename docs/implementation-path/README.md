...
88a. [artifacts/2026-05-09-gcp-phase3e-sqlite-pilot-evidence.md](artifacts/2026-05-09-gcp-phase3e-sqlite-pilot-evidence.md) — **GCP ONLY / NON-PROD**: Phase 3E evidence artifact from read-only run; signed conditional single-node SQLite pilot; NOT production-ready, NOT full G2/full production pilot authorization, NOT Phase 3E operator signoff
89. [100-phase3f-conditional-sqlite-pilot-authorization.md](100-phase3f-conditional-sqlite-pilot-authorization.md) — **GCP ONLY / NON-PROD**: Phase 3F conditional single-node SQLite pilot authorization; YES/NO matrix; synthesizes signed docs 54/99/63/65 and Phase 3A–3E evidence; conditional pilot only; NOT full production-ready, NOT PostgreSQL, NOT HA/multi-node, NOT full production posture
90. [101-phase3g-ops-hardening-plan.md](101-phase3g-ops-hardening-plan.md) — **GCP ONLY / NON-PROD**: Phase 3G ops hardening scaffolds for real-domain TLS, offsite backup to GCS, and monitoring/alerting; scripts require --confirm and required inputs; NOT actual GCP mutation; NOT production-ready, NOT full production posture, NOT deployment without real domain/bucket/alert contact
90a. [artifacts/2026-05-09-gcp-phase3g-scaffold-review.md](artifacts/2026-05-09-gcp-phase3g-scaffold-review.md) — **GCP ONLY / NON-PROD**: Phase 3G scaffold review artifact; --help and bash -n passed; VM evidence from Phase 3E rerun; blocked deployment inputs matrix; next operator actions; Phase 3H now executed offsite backup and local monitoring (real domain still blocked); NOT actual GCP mutation, NOT production-ready, NOT full production posture
90b. [artifacts/2026-05-09-gcp-phase3h-offsite-monitoring.md](artifacts/2026-05-09-gcp-phase3h-offsite-monitoring.md) — **GCP ONLY / NON-PROD**: Phase 3H execution artifact; GCS offsite backup configured with dedicated SA; local Prometheus/AlertManager deployed; metrics-format fix applied; Phase 3E rerun passed; operational deltas documented (gsutil PATH, VM OAuth scope, monitoring wiring); NOT production-ready, NOT production alerting, NOT real domain deployment, NOT production posture
90c. [artifacts/2026-05-09-gcp-phase3i-no-domain-followup.md](artifacts/2026-05-09-gcp-phase3i-no-domain-followup.md) — **GCP ONLY / NON-PROD**: Phase 3I no-domain follow-up artifact; GCS offsite restore drill evidence (INTEGRITY=ok, TABLE_COUNT=14, SIZE_BYTES=241664); local pre-target gate passed (ALL LOCAL CHECKS PASSED); Phase 3H operational deltas captured; real domain remains BLOCKED; NOT production-ready, NOT production alerting, NOT production posture
90d. [artifacts/2026-05-09-gcp-phase3j-duckdns-tls-attempt.md](artifacts/2026-05-09-gcp-phase3j-duckdns-tls-attempt.md) — **GCP ONLY / NON-PROD**: Phase 3J DuckDNS TLS; DNS A resolves to VM IP (34.158.51.8); initial ACME attempt BLOCKED by DuckDNS/CAA DNS instability (CAA timeout, SERVFAIL); **retry SUCCESS** — certificate obtained, DuckDNS HTTPS working, Prometheus retargeted; NOT production-ready, NOT real owned domain, NOT production alerting
91. [102-phase4a-ops-hardening-alert-bridge-plan.md](102-phase4a-ops-hardening-alert-bridge-plan.md) — **GCP ONLY / NON-PROD**: Phase 4A ops hardening and SendGrid alert bridge plan; backup cadence audit, offsite restore drill, metrics baseline helper scripts; SendGrid bridge template with placeholder API key; VM-local secret handling; NOT production-ready, NOT production alerting, NOT real SendGrid API key stored, NOT PostgreSQL, NOT HA
91a. [artifacts/2026-05-09-phase4a-ops-hardening-alert-bridge-plan.md](artifacts/2026-05-09-phase4a-ops-hardening-alert-bridge-plan.md) — **GCP ONLY / NON-PROD**: Phase 4A artifact; helper script syntax validation (bash -n passed for all 3 scripts); SendGrid bridge template documented; DuckDNS TLS primary (Phase 3J success); NOT production-ready, NOT production alerting, NOT real SendGrid API key or email, NOT PostgreSQL, NOT HA
91b. [artifacts/2026-05-10-phase4a-sendgrid-bridge-evidence.md](artifacts/2026-05-10-phase4a-sendgrid-bridge-evidence.md) — **GCP ONLY / NON-PROD**: Phase 4A SendGrid bridge live test evidence; direct SendGrid API email (HTTP 202) and AlertManager→SendGrid webhook both delivered; operator confirmed receipt of both; historical sender verification blocker documented; NOT production-ready, NOT production alerting YES, NOT PostgreSQL, NOT HA
91c. [artifacts/2026-05-10-phase4a-live-hardening-evidence.md](artifacts/2026-05-10-phase4a-live-hardening-evidence.md) — **GCP ONLY / NON-PROD**: Phase 4A live hardening evidence; backup cadence audit PASSED (timer=YES, GCS mtime=2026-05-10T03:07:21Z, RPO=9s WITHIN RPO), offsite restore drill PASSED (INTEGRITY=ok, TABLE_COUNT=14, SIZE_BYTES=241664, cleanup=success), metrics baseline PASSED (TLS=ferrumgate.duckdns.org, healthy, write_queue=0); helper script fixes documented (URL parsing bug, age computation bug, multi-line COPY_SUCCESS bug); SendGrid rotate BLOCKED pending operator action; NOT production-ready, NOT production alerting, NOT PostgreSQL, NOT HA
91d. [artifacts/2026-05-17-sendgrid-rotation-evidence.md](artifacts/2026-05-17-sendgrid-rotation-evidence.md) — **GCP ONLY / NON-PROD**: SendGrid API key rotation evidence; active secret path/permission fix, primary+secondary delivery confirmation, old-key revocation, SSH firewall restoration; no secrets, no production-ready claim
91e. [artifacts/2026-05-17-escalation-matrix-acknowledgment.md](artifacts/2026-05-17-escalation-matrix-acknowledgment.md) — **GCP ONLY / NON-PROD**: Formal escalation matrix acknowledgment for primary/secondary alert paths and timeout targets; closes Block B; no contact details, no secrets, no production-ready claim
103. [103-phase4d-postgres-p3-local-implementation-plan.md](103-phase4d-postgres-p3-local-implementation-plan.md) — **LOCAL DOCKER / POSTGRESQL P3**: PostgreSQL P3 local implementation complete; repo-by-repo checklist (9 repos with real `sqlx::query` implementations), schema/migration strategy, test gates, invariant gates, local Docker target; P3/P4.1–P4.3 Rust implementation complete; NOT production-ready, NOT HA/multi-node; P4.4 MVP complete (dry-run default, --apply, empty-target safety, count+ID validation); P5 production readiness deferred
