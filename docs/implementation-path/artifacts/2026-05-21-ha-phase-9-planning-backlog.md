...
| HA-3 | Read replica behavior designed | ✅ DESIGN DRAFTED — planning artifact 2026-05-21; no implementation |
...
| H.3 | Design read-replica routing (read-only endpoints → replica, writes → primary) | P2 | Engineering | Design doc drafted 2026-05-21; readiness probe behavior includes replica lag; no implementation |
