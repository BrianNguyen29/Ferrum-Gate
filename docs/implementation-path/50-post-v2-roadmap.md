...
- **Status:** ✅ DONE — H1.2a and H1.2b both delivered
...
| Sub-slice | What | Status |
|-----------|------|--------|
| **H1.2a** | Richer outcome clause expressiveness — temporal constraints (H1.2a: temporal-first; nested selectors deferred) | ✅ DONE |
...
- **Status:** 🏗 IN PROGRESS — H1.3a ✅ DONE; H1.3b ✅ DONE (git-native credential delegation); H1.3c (mirroring) remain
...
| H1.3 git deeper integration | `11-remaining-tasks.md` lines 83-87 | H1.3a ✅ DONE (remote config); H1.3b ✅ DONE (credential delegation); H1.3c remain |
