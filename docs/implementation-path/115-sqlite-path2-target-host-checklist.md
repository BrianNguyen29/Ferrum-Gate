...
| 2026-05-15 | (SUPERSEDED — see final 2026-05-15 delegated closure row below.) B1 D1–D6 passed 6/6 on target host. B2 restore drill passed after ferrumctl fix (0.463s). G3.6 fully accepted for P5b engineering review only. At this time B3 retention pruning was not yet verified, B4 was partial evidence, and B5 with-token had PASSED after target-env remediation but operator checklist steps were not yet independently witnessed. Full operator execution pending. No production-ready claim. See [`artifacts/2026-05-13-d1-d6-target-host-evidence.md`](../artifacts/2026-05-13-d1-d6-target-host-evidence.md), [`artifacts/2026-05-15-g36-t3b-restore-drill-fixed-success-evidence.md`](../artifacts/2026-05-15-g36-t3b-restore-drill-fixed-success-evidence.md), and [`artifacts/2026-05-15-b3-b4-b5-delegated-signing-status.md`](../artifacts/2026-05-15-b3-b4-b5-delegated-signing-status.md). | Engineering |
| 2026-05-15 | (SUPERSEDED — see final 2026-05-15 delegated closure row below.) Added functional evidence notes to §4 B5 and §5 B4. B4: HTTPS healthz/readyz/readyz/deep 200, HTTP→HTTPS redirect 308, with-token auth through proxy 200 after remediation. B5: with-token GET /v1/approvals HTTP 200 after target-env remediation. At this time B3/B4/B5 operator checkboxes were still ☐ (later checked via delegated authority). Added guardrail note that functional evidence does not substitute operator checklist execution or production readiness. | Engineering |
| 2026-05-15 | (SUPERSEDED — see final 2026-05-15 delegated closure row below.) B3 target retention-pruning functional evidence recorded (run id 20260515T1606Z-b3-retention). Old matching sentinel pruned, non-matching preserved, new backup verified OK, service healthy. At this time operator checklist steps were not yet independently witnessed and B3 checkbox was still ☐ (later checked via delegated authority). No production-ready claim. | Engineering |
