...
| G3.6 | G2 pilot data available for P5b pool-tuning input | `106-g3-6-pilot-metrics-evidence-packet.md` | Operator | ☑ CONDITIONALLY ACCEPTED (2026-05-11; BrianNguyen; A1–A5 met with caveats; A6 accepted with conditions) |

**Do not begin Phase P1 (ADR-50) until G3.1–G3.4 are all satisfied.** G3.1–G3.4 are now satisfied. G3.5 is satisfied. G3.6 is **conditionally accepted** and blocks P5b–P5e implementation **only if** conservative defaults and post-deploy monitoring are not used.
