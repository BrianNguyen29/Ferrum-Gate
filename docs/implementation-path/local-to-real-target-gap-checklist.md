...
| PostgreSQL production deployment | Local runtime support implemented (P3/P4.1–P4.3). P4.4 MVP complete (dry-run default, --apply, empty-target safety, count+ID validation); P5 production readiness (HA, multi-node, operator signoff) deferred |
