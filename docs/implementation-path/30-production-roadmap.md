...
| P2.4 | git remote workflows — push/fetch/pull integration | 🔄 IN PROGRESS (Slice 1: GitPush against local temporary remotes ✅ 2026-04-04; fetch/pull not yet implemented) | `ferrum-adapter-git`: `test_gitpush_prepare_captures_pre_push_state`, `test_gitpush_prepare_rejects_dirty_repo`, `test_gitpush_prepare_rejects_missing_remote`, `test_gitpush_execute_performs_push`, `test_gitpush_verify_confirms_push`, `test_gitpush_verify_fails_when_remote_differs`, `test_gitpush_rollback_force_pushes_pre_ref`, `test_gitpush_happy_path_full_flow` |
...
| P2.6 | maildraft — governed-path entry analysis + EmailSend adapter contract draft (preflight slice) | 🔄 IN PROGRESS (Slice 1: governed-path entry analysis ✅ 2026-04-04; EmailSend adapter contract draft ✅ 2026-04-04; provider send integration TBD post-v1) | `docs/implementation-path/36-p2-6-emailsend-governed-path-entry-analysis.md`; `docs/implementation-path/37-p2-6-emailsend-adapter-contract-draft.md`; deny-regression tests: `test_email_allow_send_true_prepare_denied_with_explicit_error`, `test_maildraft_adapter_rejects_send_payload` |
| P2.7 | maildraft — broader verify semantics hardening | 🔄 IN PROGRESS (Slice 1: explicit EmailDraftExists verify_checks handling ✅ 2026-04-04) | `ferrum-adapter-maildraft`: `test_maildraft_adapter_verify_with_explicit_email_draft_exists_check_passes`, `test_maildraft_adapter_verify_with_explicit_email_draft_exists_check_fails` |
...
7. **P2.7** — maildraft broader verify semantics hardening (Slice 1 ✅ 2026-04-04)
