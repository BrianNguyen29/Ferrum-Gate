...
| P2.4 | git remote workflows — push/fetch/pull integration | 🔄 IN PROGRESS (Slice 1: GitPush against local temporary remotes ✅ 2026-04-04; Slice 2: GitFetch against local temporary remotes ✅ 2026-04-04; pull not yet implemented) | `ferrum-adapter-git`: GitPush tests (8 tests) + GitFetch tests (7 tests: prepare_captures_state, prepare_rejects_missing_remote, execute_performs_fetch, verify_confirms_fetch, verify_fails_when_local_ref_differs, rollback_deletes_new_local_ref, happy_path_full_flow) |
