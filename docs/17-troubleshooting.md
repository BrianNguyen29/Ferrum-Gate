...
## Action bi quarantine
Kiem tra:
- taint score
- trust labels
- contradiction giua intent va proposal
...
- Single-node operations runbook: `docs/18-single-node-operations-runbook.md`
- v1 single-node operator checks: `docs/20-v1-single-node-operator-checks.md`
- v1 single-node observability minimums: `docs/21-v1-single-node-observability-minimums.md`
