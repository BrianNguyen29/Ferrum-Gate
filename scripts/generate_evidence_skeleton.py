...
Output is markdown suitable for copying into:
    - docs/PRODUCTION_NOTES.md (internal evidence bundles are not part of public docs)
"""
...
>   - D1-D6 drills: `docs/PRODUCTION_NOTES.md`
>   - G2 pilot readiness: `docs/PRODUCTION_NOTES.md`
>
