...
Verifies baseline required sections/phrases appropriate for evidence templates.
Note: Evidence templates are internal artifacts and not part of public documentation.
...
# Templates are internal operator aids, not part of public docs
ARTIFACTS_DIR = "docs/guides"
...
def main() -> int:
    ...
    if not template_paths:
        print(f"[SKIP] No evidence templates found (TEMPLATE-*.md not present in {ARTIFACTS_DIR})")
        print(f"[SKIP] Evidence templates are internal operator aids; skipping validation.")
        return 0
