...
> - DuckDNS remains conditional-only; a real owned domain is required for any production-ready claim.
>
> See `docs/production-readiness-v2/08-hosted-deployment-plan.md` and `11-blockers-and-unblock-plan.md` for scope.
...
- [`docs/production-readiness-v2/08-hosted-deployment-plan.md`](../../docs/production-readiness-v2/08-hosted-deployment-plan.md)
- [`docs/production-readiness-v2/11-blockers-and-unblock-plan.md`](../../docs/production-readiness-v2/11-blockers-and-unblock-plan.md)
