...
Xem [ma trận độ sẵn sàng của các subsystem trong ROADMAP.md](./docs/ROADMAP.md#subsystem-readiness-matrix) để biết mức độ trưởng thành P0–P5 hiện tại của core governance, adapter, MCP transport, store, HA, WORM, anomaly detection và operator tooling.
