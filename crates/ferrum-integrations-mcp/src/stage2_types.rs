...
///
/// **REMOVED (D1.3.3):** This struct was a D1.3.1 placeholder that did NOT
/// match the real gateway `IntentCompileResponse`.
///
/// Per doc 79 P3: The real gateway compile response is:
/// ```json
...
///
/// D1.3.3 now re-exports the real `ferrum_proto::IntentCompileResponse` in lib.rs.
///
/// Use `generate_proposal_id()` to create a client-side proposal ID before
/// calling proposal evaluation (D1.3.4+).
