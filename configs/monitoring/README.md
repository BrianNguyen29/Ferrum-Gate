...
```bash
# Local-only mode: copy configs to your monitoring stack
...
# Replace ${ALERT_CONTACT} placeholder with your contact info
```
...
**Path**: `docs/guides/operator.md` (operator runbook) or local artifact directory
